...
[![Build Status](https://travis.ibm.com/art-zurich/blueprint-python-package.svg?token=bmUqdLriQp1g3yv7TJC6&branch=master)](https://travis.ibm.com/art-zurich/blueprint-python-package)
[![GitHub Pages](https://img.shields.io/badge/docs-sphinx-blue)](https://pages.github.ibm.com/art-zurich/blueprint-python-package/)
...
- [ ] [.travis.yml](.travis.yml) notifications: delete the section if undesired, else set up a slack channel and set the token. Go to [travis](https://ibm-research.slack.com/apps/new/A0F81FP4N-travis-ci) and create a token (with `public_repo` or `repo` access level) for the channel you want to post into.
...
- [ ] Set up Travis, including a [github token](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token) in case of pushing docs.
...
- [ ] Add [Slack integration](https://ibm-research.slack.com/apps/A0F7YS2SX-github-enterprise-server) for GitHub to receive notifications 
- [] update `copyright` in `doc/setup.py` file 
